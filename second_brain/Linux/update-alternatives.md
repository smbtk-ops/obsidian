...
### 5.2. Настройка python на python3.10
...
## 6. Ключи команды update-alternatives
...
| --auto           | Включить автоматический режим выбора          | `sudo update-alternatives --auto editor`                                     |
...
## 7. Пояснение к ключевым командам
...
## 8. Просмотр существующих групп альтернатив
...
## 10. Создание своей группы альтернатив
